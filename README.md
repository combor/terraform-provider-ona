# Terraform Provider for Ona — combor/ona
...
Community-maintained Terraform provider for [Ona](https://ona.com) (formerly Gitpod), published as [`combor/ona`](https://registry.terraform.io/providers/combor/ona/latest).
